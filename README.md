...
pixi add libdali libdali-devel nvidia-dali-python
# for installing globally
pixi global install libdali libdali-devel nvidia-dali-python
```
...
It is possible to list all of the versions of `libdali` available on your platform:
...
```
pixi search libdali --channel conda-forge
```
